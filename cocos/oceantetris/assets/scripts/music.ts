 ...
 * @LastEditTime: 2022-11-22 01:55:00
...
export class music extends Component {
    ...
    initMusicEvent() {
        ...
        this.node.on("gameover", () => this.soundControl.playOneShot(this.effects[0], 0.8), this)
        this.node.on("cleanOneLine", () => this.soundControl.playOneShot(this.effects[0], 0.8), this)
