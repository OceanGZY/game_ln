...
AMPTestCharacter::AMPTestCharacter():
	CreateSessionCompleteDelegate(FOnCreateSessionCompleteDelegate::CreateUObject(this,&AMPTestCharacter::OnCreateSessionComplete))
	,FindSessionsCompleteDelegate(FOnFindSessionsCompleteDelegate::CreateUObject(this,&AMPTestCharacter::OnFindSessionsComplete))
	,JoinSessionCompleteDelegate(FOnJoinSessionCompleteDelegate::CreateUObject(this,&AMPTestCharacter::OnJoinSessionComplete))
{
...
void AMPTestCharacter::CreateGameSession() const
{
